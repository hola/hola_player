...
1. Add this script to your document's `<head>`:
  ...
  ```html
  <script src="//cdn.jsdelivr.net/hola_player/1.0.27/hola_player.js"></script>
  ```
  ...
  ```html
  <script src="//cdn.jsdelivr.net/hola_player/1.0.27/hola_player.js?customer=xxx"></script>
  ```
...
You can also [Download](https://github.com/hola/hola_player/raw/v1.0.27/dist/hola-player-1.0.27.zip) prebuilt package and host it on your website.
